    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // Memastikan bahwa kedua input tidak kosong
                if ((etangka1.getText().length() > 0) && (etangka2.getText().length() > 0)) {
                    double a1 = Double.parseDouble(etangka1.getText().toString());
                    double a2 = Double.parseDouble(etangka2.getText().toString()); // Diperbaiki dari etangka1 ke etangka2
                    double result = a1 + a2;
        ...
        bbagi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if ((etangka1.getText().length() > 0) && (etangka2.getText().length() > 0)) {
                    double a1 = Double.parseDouble(etangka1.getText().toString());
                    double a2 = Double.parseDouble(etangka2.getText().toString()); // Diperbaiki dari etangka1 ke etangka2
                    if (a2 != 0) { // Cek pembagian dengan nol
                        double result = a1 / a2;
                        thasil.setText(Double.toString(result));
                    } else {
                        Toast.makeText(Kalkulator.this, "Pembagi tidak boleh nol", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(Kalkulator.this, "Angka1 dan Angka2 tidak boleh kosong", Toast.LENGTH_SHORT).show();
                }
